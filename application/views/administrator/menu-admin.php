        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              <a href="#"><i class="fa fa-home"></i> <span>Modul Sekolah</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                $cek=$this->model_app->umenu_akses("sekolah",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/sekolah'><i class='fa fa-circle-o'></i> Sekolah</a></li>";
                }

                $cek=$this->model_app->umenu_akses("guru",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/guru'><i class='fa fa-circle-o'></i> Guru</a></li>";
                }

                $cek=$this->model_app->umenu_akses("siswa",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/siswa'><i class='fa fa-circle-o'></i> Murid</a></li>";
                }
			...
			<li class="treeview">
              <a href="#"><i class="fa fa-book"></i> <span>Modul Beasiswa</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                $cek=$this->model_app->umenu_akses("sekolah",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/beasiswa'><i class='fa fa-circle-o'></i> Beasiswa</a></li>";
                }

                $cek=$this->model_app->umenu_akses("guru",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url().$this->uri->segment(1)."/penerimabeasiswa'><i class='fa fa-circle-o'></i> Penerima Beasiswa</a></li>";
                }
            ...
            <li><a href="<?php echo base_url().$this->uri->segment(1); ?>/edit_manajemenuser/<?php echo $this->session->username; ?>"><i class="fa fa-cog"></i> <span>Edit Profile</span></a></li>
