...
<section class="col-lg-7 connectedSortable">
  ...
  <div class='box'>
    ...
    <div class='box-body'>
	  ...
	  <a href="<?php echo base_url().$this->uri->segment(1); ?>/sekolah" class='btn btn-app'><i class='fa fa-home'></i> Sekolah</a>
	  <a href="<?php echo base_url().$this->uri->segment(1); ?>/beasiswa" class='btn btn-app'><i class='fa fa-book'></i> Beasiswa</a>
