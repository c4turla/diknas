...
<title><?php echo $title; ?></title>
	...
	<meta name="author" content="kendariweb.com">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>/template/phpmu-tigo/button.datatable.min.css">
	<?php endif; ?>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/nivo-slider.css">
	<link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/themes/light/light.css">
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/jquery.nivo.slider.js"></script>
	<?php } ?>
	...
	<style type="text/css">
		.the-menu a.active{ color:#eae2e2 !important; }
	</style>
</head>
  ...
  <img alt='Scroll to top' src='<?php echo base_url(); ?>asset/images/top.png'/>
		...
		<div class="boxed">	
            ...
            <div id="slider" class="nivoSlider">
                <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/images/adat.jpg" data-thumb="images/toystory.jpg" alt="" title="#htmlcaption1"/>
                <!--<a href=""><img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/images/up.jpg" data-thumb="images/up.jpg" alt="" title="This is an example of a caption" /></a>
                //<img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/images/walle.jpg" data-thumb="images/walle.jpg" alt="" data-transition="slideInLeft" />-->
                <img src="<?php echo base_url(); ?>template/<?php echo template(); ?>/nivoslider/images/nemo.jpg" data-thumb="images/nemo.jpg" alt="" title="#htmlcaption" />
            </div>
			<div id="htmlcaption1" class="nivo-html-caption">
                <strong>Pakaian Adat</strong> Kabupaten Bombana. 
            </div>
            <div id="htmlcaption" class="nivo-html-caption">
                <strong>Kepala Dinas Pendidikan Pemuda dan Olahraga</strong> Kabupaten Bombana. 
            </div>
        </div>
